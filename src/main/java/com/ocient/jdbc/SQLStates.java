...
public class SQLStates {
	...
	public static SQLStates INVALID_COLUMN_TYPE = new SQLStates("Corruption of serialized result set", SYSTEM_ERROR,
			INVALID_COLUMN_CODE);
	public static SQLStates MALFORMED_URL = new SQLStates("Malformed connection URL", UNABLE_TO_CONNECT,
			MALFORMED_URL_CODE);
	public static SQLStates FAILED_CONNECTION = new SQLStates("Connection failed", UNABLE_TO_CONNECT,
			FAILED_CONNECTION_CODE);
	public static SQLStates FAILED_HANDSHAKE = new SQLStates("The handshake between client and server failed",
			UNABLE_TO_CONNECT, FAILED_HANDSHAKE_CODE);
	public static SQLStates INVALID_ARGUMENT = new SQLStates("The argument to a client method call was invalid",
			CLIENT_ERROR, INVALID_ARGUMENT_CODE);
	public static SQLStates CALL_ON_CLOSED_OBJECT = new SQLStates("A client method was called on a closed object",
			CLIENT_ERROR, CALL_ON_CLOSED_OBJECT_CODE);
	public static SQLStates COLUMN_NOT_FOUND = new SQLStates("The referenced column does not exist",
			COLUMN_NOT_FOUND_STATE, COLUMN_NOT_FOUND_CODE);
	public static SQLStates CORRELATED_SUBQUERY = new SQLStates("Correlated subqueries are not supported",
			COLUMN_NOT_FOUND_STATE, COLUMN_NOT_FOUND_CODE);
	public static SQLStates CURSOR_NOT_ON_ROW = new SQLStates("The cursor was not positioned on a valid row",
			INVALID_CURSOR, CURSOR_NOT_ON_ROW_CODE);
	public static SQLStates INVALID_DATA_TYPE_CONVERSION = new SQLStates(
			"Unable to do the requested data type conversion", NOT_IMPLEMENTED_STATE,
			INVALID_DATA_TYPE_CONVERSION_CODE);
	public static SQLStates UNEXPECTED_EOF = new SQLStates("Unexpected EOF on network connection", UNABLE_TO_CONNECT,
			UNEXPECTED_EOF_CODE);
	public static SQLStates NETWORK_COMMS_ERROR = new SQLStates("A network communications error occurred",
			UNABLE_TO_CONNECT, NETWORK_COMMS_ERROR_CODE);
	public static SQLStates PREVIOUS_RESULT_SET_STILL_OPEN = new SQLStates(
			"Only one result set can be open at a time on a given connection", CURSOR_ALREADY_ASSIGNED_TO_RS,
			PREVIOUS_RESULT_SET_STILL_OPEN_CODE);
	public static SQLStates UNKNOWN_DATA_TYPE = new SQLStates("Unknown data type", BAD_DATA_TYPE,
			UNKNOWN_DATA_TYPE_CODE);
	public static SQLStates BAD_USER_PWD = new SQLStates("The userid/password combination was not valid",
			REJECTED_CONNECTION, BAD_USER_PWD_CODE);
	public static SQLStates OK = new SQLStates("The operation completed successfully", NORMAL_COMPLETION,
			NORMAL_COMPLETION_CODE);
	public static SQLStates NETFLOW_DEMO_RESTRICTIONS_VIOLATED = new SQLStates(
			"The SQL statement is not supported by the netflow demo", SQL_NOT_VALID_IN_CONTEXT,
			SQL_NOT_VALID_IN_CONTEXT_CODE);
	public static SQLStates SYNTAX_ERROR = new SQLStates("There is a syntax error in your statement",
			SYNTAX_ERROR_STATE, SYNTAX_ERROR_CODE);
	public static SQLStates INTERNAL_ERROR = new SQLStates("An internal error occurred", SYSTEM_ERROR,
			INTERNAL_ERROR_CODE);
	public static SQLStates DUPLICATE_CTE_NAME = new SQLStates("There is a duplicate common table expression name",
			DUPLICATE_CTE_NAME_STATE, DUPLICATE_CTE_CODE);
	public static SQLStates SELECT_NUM_COLS_MISMATCH = new SQLStates(
			"The number of columns does not match the SELECT statement", SELECT_NUM_COLS_MISMATCH_STATE,
			SELECT_NUM_COLS_MISMATCH_CODE);
	public static SQLStates INVALID_BY_EXPRESSION = new SQLStates(
			"The expression in the ORDER BY or GROUP BY clause is not valid.", INVALID_BY_EXPRESSION_STATE,
			INVALID_BY_EXPRESSION_CODE);
	public static SQLStates NEGATIVE_LIMIT = new SQLStates("The value of the LIMIT clause was negative",
			INVALID_LIMIT_STATE, NEGATIVE_LIMIT_CODE);
	public static SQLStates NEGATIVE_OFFSET = new SQLStates("The value of the OFFSET clause was negative",
			INVALID_OFFSET_STATE, NEGATIVE_OFFSET_CODE);
	public static SQLStates WRONG_NUMBER_OF_FUNCTION_ARGUMENTS = new SQLStates(
			"Wrong number of arguments in function call", WRONG_NUMBER_OF_ARGUMENTS_STATE,
			WRONG_NUMBER_OF_ARGUMENTS_CODE);
	public static SQLStates AGGREGATION_ON_CONSTANT = new SQLStates("Aggregation of a constant value is invalid",
			INVALID_ARGUMENT_STATE, AGGREGATION_ON_CONSTANT_CODE);
	public static SQLStates WRONG_FUNCTION_ARGUMENT_TYPE = new SQLStates(
			"The data type of a function parameter is invalid", INVALID_ARGUMENT_STATE, WRONG_ARGUMENT_TYPE_CODE);
	public static SQLStates INVALID_COMPARISON = new SQLStates("A comparison operation is invalid",
	...
	public static SQLStates AMBIGUOUS_COL = new SQLStates("A column name was ambiguous", AMBIGUOUS_COL_STATE,
			AMBIGUOUS_COL_CODE);
	public static SQLStates NO_AGG_IN_HAVING = new SQLStates(
			"There is no aggregation in the predicate in the HAVING clause", INVALID_AGGREGATION_STATE,
			NO_AGG_IN_HAVING_CODE);
	public static SQLStates SELECT_AFTER_AGG = new SQLStates(
			"A column reference in a SELECT clause is invalid due to aggregation", INVALID_AGGREGATION_STATE,
	...
	public static SQLStates LIST_TYPE_IN_SELECT_LIST = new SQLStates("A query cannot return a list type", BAD_DATA_TYPE,
			LIST_TYPE_IN_SELECT_LIST_CODE);
	public static SQLStates LIST_WITHIN_LIST = new SQLStates("Nested lists are not allowed", SYNTAX_ERROR_STATE,
			LIST_WITHIN_LIST_CODE);
	public static SQLStates INCOMPATIBLE_TYPES_IN_LIST = new SQLStates(
			"All data types within a list must be implicitly convertible to a common data type",
			BAD_SCALAR_TYPE_IN_LIST, INCOMPATIBLE_TYPES_IN_LIST_CODE);
	public static SQLStates NO_SUCH_FUNCTION = new SQLStates("Call to unknown function", INVALID_FUNCTION_USE,
			UNKNOWN_FUNCTION_CODE);
	public static SQLStates TKT_RESTRICTIONS_VIOLATED = new SQLStates(
			"The SQL statement is not supported by the TKT engine", SQL_NOT_VALID_IN_CONTEXT,
			SQL_NOT_VALID_IN_CONTEXT_CODE);
	...
	public static SQLStates NOT_A_SELECT = new SQLStates(
			"A SELECT statement was expected, but the command received was not a SELECT statement",
			SQL_NOT_VALID_IN_CONTEXT, NOT_A_SELECT_CODE);
	public static SQLStates IS_A_SELECT = new SQLStates(
			"A SELECT statement was found where we were not expecting a SELECT statement", SQL_NOT_VALID_IN_CONTEXT,
			IS_A_SELECT_CODE);
	public static SQLStates ML_MODEL_NOT_FOUND = new SQLStates("Could not find an MLMODEL with that name",
			OBJECT_NOT_FOUND_STATE, ML_MODEL_NOT_FOUND_CODE);
	public static SQLStates ML_MODEL_ALREADY_EXISTS = new SQLStates("An MLMODEL with that name already exists",
			DUPLICATE_OBJECT, ML_MODEL_ALREADY_EXISTS_CODE);
	public static SQLStates NULL_OUTPUT_BUFFER = new SQLStates(
			"A null pointer was passed for an output buffer location to an ODBC API call", GENERAL_DRIVER_ERROR,
			NULL_OUTPUT_BUFFER_CODE);
	public static SQLStates NOT_IMPLEMENTED = new SQLStates("The requested function is not implemented",
			NOT_IMPLEMENTED_STATE, NOT_IMPLEMENTED_CODE);
	public static SQLStates SEQUENCE_ERROR = new SQLStates("ODBC function sequence error", SEQUENCE_ERROR_STATE,
			SEQUENCE_ERROR_CODE);
	public static SQLStates INVALID_ATTRIBUTE = new SQLStates("An invalid ODBC attribute was specified",
			INVALID_ATTRIBUTE_STATE, INVALID_ATTRIBUTE_CODE);
	public static SQLStates INVALID_INPUT = new SQLStates("Invalid input to an ODBC API call", INVALID_INPUT_STATE,
			INVALID_INPUT_CODE);
	public static SQLStates DYNAMIC_LINK_FAILURE = new SQLStates(
			"The ODBC driver failed to load a required symbol from a shared library", GENERAL_DRIVER_ERROR,
			DYNAMIC_LINK_FAILURE_CODE);
	public static SQLStates BAD_PARAM_NUM = new SQLStates("An invalid parameter marker number was specified",
			BAD_PARAM_NUM_STATE, BAD_PARAM_NUM_CODE);
	public static SQLStates INVALID_C_DATA_TYPE = new SQLStates("An invalid C data type was specified",
			INVALID_C_DATA_TYPE_STATE, INVALID_C_DATA_TYPE_CODE);
	public static SQLStates INVALID_SQL_DATA_TYPE = new SQLStates("An invalid SQL data type was specified",
			INVALID_SQL_DATA_TYPE_STATE, INVALID_SQL_DATA_TYPE_CODE);
	public static SQLStates NO_CONNECTION = new SQLStates("No database connection exists", NO_CONNECTION_STATE,
			NO_CONNECTION_CODE);
	public static SQLStates INVALID_PARAMETER_MARKER = new SQLStates("Invalid data was detected for a parameter marker",
			INVALID_PARAMETER_MARKER_STATE, INVALID_PARAMETER_MARKER_CODE);
	public static SQLStates TRUNCATION = new SQLStates("Data was truncated while transferring data to/from the server",
			TRUNCATION_STATE, TRUNCATION_CODE);
	public static SQLStates INVALID_CURSOR_STATE = new SQLStates(
			"The cursor was not in the necessary state for the requested operation", INVALID_CURSOR,
			INVALID_CURSOR_CODE);
	public static SQLStates INVALID_BUFFER_LENGTH = new SQLStates("An invalid buffer length was specified",
			INVALID_BUFFER_LENGTH_STATE, INVALID_BUFFER_LENGTH_CODE);
	public static SQLStates NO_ROW_DATA = new SQLStates("No data found", NO_ROW_DATA_STATE, NO_ROW_DATA_CODE);
	public static SQLStates INVALID_MATRIX_LITERAL = new SQLStates("The syntax of the matrix was invalid",
			SYNTAX_ERROR_STATE, INVALID_MATRIX_LITERAL_CODE);
	public static SQLStates WRONG_SHAPE_MATRIX_LITERAL = new SQLStates("The matrix has the wrong dimensions",
			SYNTAX_ERROR_STATE, WRONG_SHAPE_MATRIX_LITERAL_CODE);
	public static SQLStates EXCESSIVE_COST = new SQLStates("The estimated query cost exceeds limit",
			EXCESSIVE_COST_STATE, EXCESSIVE_COST_CODE);
	public static SQLStates ML_MODEL_ON_EMPTY_SET = new SQLStates("Training MLMODEL on no data", NO_ROW_DATA_STATE,
			ML_MODEL_ON_EMPTY_SET_CODE);
	public static SQLStates NO_RESULT_SET = new SQLStates("There is currently no result set", NO_CURSOR_STATE,
			NO_RESULT_SET_CODE);
	public static SQLStates MISSING_NULL_INDICATOR = new SQLStates(
			"A null indicator pointer was required but was not provided", MISSING_NULL_INDICATOR_STATE,
			MISSING_NULL_INDICATOR_CODE);
	public static SQLStates INVALID_CONN_STR_ATTR = new SQLStates(
			"An invalid connection string attribute was specified", INVALID_CONN_STR_ATTR_STATE,
			INVALID_CONN_STR_ATTR_CODE);
	public static SQLStates INVALID_DESCRIPTOR_INDEX = new SQLStates("An invalid descriptor record index was specified",
			INVALID_DESCRIPTOR_INDEX_STATE, INVALID_DESCRIPTOR_INDEX_CODE);
	public static SQLStates INVALID_DESCRIPTOR_INFORMATION = new SQLStates(
			"An invalid or inconsistent descriptor field type was specified", INVALID_DESCRIPTOR_INFORMATION_STATE,
			INVALID_DESCRIPTOR_INFORMATION_CODE);
	public static SQLStates INVALID_DESCRIPTOR_FIELD = new SQLStates("An invalid descriptor field was specified",
			INVALID_DESCRIPTOR_FIELD_STATE, INVALID_DESCRIPTOR_FIELD_CODE);
	public static SQLStates COPY_TARGET_IS_IRD = new SQLStates("The target handle passed to SQLCopyDesc was an IRD",
			COPY_TARGET_IS_IRD_STATE, COPY_TARGET_IS_IRD_CODE);
	public static SQLStates INVALID_IMPLICIT_DESC_HANDLE_USE = new SQLStates(
			"Invalid use of an automatically allocated descriptor handle", INVALID_IMPLICIT_DESC_HANDLE_USE_STATE,
			INVALID_IMPLICIT_DESC_HANDLE_USE_CODE);
	public static SQLStates NO_CREATE_MLMODEL_AUTH = new SQLStates(
			"The user does not have the authority to create an MLMODEL", AUTH_FAILURE, NO_CREATE_MLMODEL_AUTH_CODE);
	public static SQLStates NO_DROP_MLMODEL_AUTH = new SQLStates(
			"The user does not have the authority to drop the MLMODEL", AUTH_FAILURE, NO_DROP_MLMODEL_AUTH_CODE);
	public static SQLStates DIVDE_BY_ZERO = new SQLStates("Division by zero is invalid", DIVIDE_BY_ZERO_STATE,
			DIVIDE_BY_ZERO_CODE);
	public static SQLStates OUT_OF_RANGE = new SQLStates("A numeric value is out of range", OUT_OF_RANGE_STATE,
	...
	public static SQLStates INVALID_QUERY_PRIORITY = new SQLStates(
			...
			SYNTAX_ERROR_STATE, INVALID_QUERY_PRIORITY_CODE);
	public static SQLStates IO_ERROR = new SQLStates("An IO error occurred", NON_DATABASE_RESOURCE_NOT_AVAILABLE_STATE,
			IO_ERROR_CODE);
	public static SQLStates INCOMPATIBLE_TYPES_IN_CASE = new SQLStates(
			"Two incompatible data types were specified as return value in a case statement",
			INCOMPATIBLE_TYPES_IN_CASE_STATE, INCOMPATIBLE_TYPES_IN_CASE_CODE);
	public static SQLStates NOT_COMPATIBLE_COLS = new SQLStates(
			"Columns for first and second select for the UNION, EXCEPT or INTERSECT operator are not compatible.",
			NOT_COMPATIBLE_COLS_STATE, NOT_COMPATIBLE_COLS_CODE);
	public static SQLStates JOIN_LEADS_TO_DUPLICATE_COL_NAME = new SQLStates(
			"Columns must be renamed so that column names are distinct after a join", AMBIGUOUS_COL_STATE,
			JOIN_LEADS_TO_DUPLICATE_COL_NAME_CODE);
	public static SQLStates SCALAR_SUBQUERY_CARDINALITY_VIOLATION = new SQLStates(
			"A scalar subquery has too many result values", SCALAR_SUBQUERY_CARDINALITY_VIOLATION_STATE,
			SCALAR_SUBQUERY_CARDINALITY_VIOLATION_CODE);
	public static SQLStates INVALID_CASE_CONDITION = new SQLStates("An expression in the case condition is not allowed",
			INVALID_CASE_CONDITION_STATE, INVALID_CASE_CONDITION_CODE);
	public static SQLStates INVALID_JOIN_CONDITION = new SQLStates("An expression in the join condition is not allowed",
			INVALID_JOIN_CONDITION_STATE, INVALID_JOIN_CONDITION_CODE);
	public static SQLStates AGGREGATION_NOT_ALLOWED_IN_WINDOW_CONSTRUCTION = new SQLStates(
	...
	public static SQLStates EXPECTED_CONST_WINDOWED_AGGREGATE_ARGUMENT = new SQLStates(
	...
	public static SQLStates BAD_RANGE_FRAME_SPECIFICATION = new SQLStates(
			"Range-based framing does not allow the PRECEDING or FOLLOWING keywords",
			BAD_RANGE_FRAME_SPECIFICATION_STATE, BAD_RANGE_FRAME_SPECIFICATION_CODE);
	public static SQLStates BAD_WINDOWED_ORDER_BY = new SQLStates(
			"Order by with a column ordinal is not allowed in a windowed aggregate", BAD_WINDOWED_ORDER_BY_STATE,
			BAD_WINDOWED_ORDER_BY_CODE);
	public static SQLStates FRAME_WITHOUT_ORDERING = new SQLStates(
			"A frame specification is not allowed if no ORDER BY is specified in a windowed aggregate",
			FRAME_WITHOUT_ORDERING_STATE, FRAME_WITHOUT_ORDERING_CODE);
	public static SQLStates BAD_END_FRAME_BOUND = new SQLStates(
			"UNBOUNDED PRECEDING is only allowed on the starting frame bound", BAD_END_FRAME_BOUND_STATE,
			BAD_END_FRAME_BOUND_CODE);
	public static SQLStates BAD_START_FRAME_BOUND = new SQLStates(
			"UNBOUNDED FOLLOWING is only allowed on the ending frame bound", BAD_START_FRAME_BOUND_STATE,
			BAD_START_FRAME_BOUND_CODE);
	public static SQLStates INVALID_FRAME_BOUNDS = new SQLStates(
			"The ending frame bound cannot be less than the starting frame bound", INVALID_FRAME_BOUNDS_STATE,
			INVALID_FRAME_BOUNDS_CODE);
	public static SQLStates FRAME_SPEC_NOT_ALLOWED = new SQLStates(
			"No frame specification is allowed for this particular windowed aggregate", FRAME_SPEC_NOT_ALLOWED_STATE,
			FRAME_SPEC_NOT_ALLOWED_CODE);
	public static SQLStates WINDOW_FUNC_EXPECTED_POSITIVE_CONSTANT = new SQLStates(
			"A window function was expecting a positive integer argument", WINDOW_FUNC_EXPECTED_POSITIVE_CONSTANT_STATE,
			WINDOW_FUNC_EXPECTED_POSITIVE_CONSTANT_CODE);
	public static SQLStates UNDEFINED_EXCEPTION = new SQLStates("Undefined exception", UNDEFINED_EXCEPTION_STATE,
			UNDEFINED_EXCEPTION_CODE); // used only when a give sql code is not found in SQLCodeToException map
	public static SQLStates MISSING_ORDER_BY = new SQLStates(
			"The requested window function requires an ORDER BY in the OVER() clause", SYNTAX_ERROR_STATE,
	...
	public static SQLStates SEGMENT_NOT_AVAILABLE = new SQLStates("Data required for query is not available",
			STORAGE_OR_DATABASE_RESOURCE_NOT_AVAILABLE_STATE, SEGMENT_NOT_AVAILABLE_CODE);
	public static SQLStates SYSTEM_INITIALIZING = new SQLStates("The system is initializing",
			STORAGE_OR_DATABASE_RESOURCE_NOT_AVAILABLE_STATE, SYSTEM_INITIALIZING_CODE);
	public static SQLStates INVALID_AGGREGATION = new SQLStates("Invalid aggregation", INVALID_AGGREGATION_STATE,
			INVALID_AGGREGATION_CODE);
	public static SQLStates ST_POINT_INVALID_CONVERSION_FROM_NULL = new SQLStates(
			"Invalid st_point conversion from NULL", ST_POINT_INVALID_CONVERSION_FROM_NULL_STATE,
			ST_POINT_INVALID_CONVERSION_FROM_NULL_CODE);
	public static SQLStates VALUE_TOO_LARGE = new SQLStates("Value larger than internal limits", VALUE_TOO_LARGE_STATE,
			VALUE_TOO_LARGE_CODE);
	public static SQLStates CASE_WITHIN_CASE = new SQLStates(
			"A CASE expression within a CASE expression is not allowed", INVALID_CASE_CONDITION_STATE,
